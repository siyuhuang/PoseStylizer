...
# input_folder = './results/fashion_APS/test_latest/images_crop/'
# output_path = './results/fashion_APS/test_latest/pckh.csv'

input_folder = './results/market_APS/test_latest/images_crop/'
output_path = './results/market_APS/test_latest/pckh.csv'
...
for image_name in tqdm(img_list):
    ...
    print (image_name, str(list(pose_cords[:, 0])), str(list(pose_cords[:, 1])))
