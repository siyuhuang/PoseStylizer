...
def cords_to_map(cords, img_size, sigma=12):
...
annotations_file = './dataset/fashion_data/fashion-resize-annotation-train.csv' #pose annotation path
...
annotations_file = './dataset/fashion_data/fashion-resize-annotation-test.csv' #pose annotation path
